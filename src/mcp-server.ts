...
class ConfluenceMcpServer {
        ...
        tools: [
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                email: {
                  type: "string",
                  description: "User email for authentication (optional if CONFLUENCE_EMAIL env var is set)",
                },
              },
              required: ["url"],
            },
  ...
  private async handleRead(args: any): Promise<any> {
    ...
    const autoGeneratedContent = DomAutoGeneratedHandler.getAutoGeneratedContent(content);
